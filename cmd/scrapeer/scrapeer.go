...
import (
	...
	"github.com/wavesplatform/gowaves/cmd/scrapeer/internal"
...
func run() error {
	...
	zap.S().Infof("Waves Scrapeer %s", version)
	...
	dispatcher := internal.NewDispatcher(apiDone, cfg.netBind, opts, reg)
...
func parseConfiguration() (*configuration, error) {
	var (
		...
		versions        = flag.String("versions", "1.1 1.0 0.17 0.16 0.15 0.14 0.13 0.10 0.9 0.8 0.7 0.6 0.3", "Space separated list of known node's versions. By default all MainNet versions are supported.")
		...
		netName         = flag.String("net-name", "Scrapeer", "Name of the node to identify on the network. Default value is \"Fork Detector\".")
